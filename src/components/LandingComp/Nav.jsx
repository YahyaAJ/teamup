    ...
    <div className=" w-full fixed 3xl:static z-50 top-0 left-0">
      <div className="flex items-center sm:justify-between shadow-[0_3px_20px_rgba(0,0,0,0.25)] sm:h-[9vh] 3xl:h-max bg-[#22A6B3] py-3 sm:px-[3%] px-7 rounded-b-xl 2xl:rounded-b-[1.5em] 3xl:rounded-b-[2em] 4xl:rounded-b-[3.5em] 5xl:rounded-b-[5.5em] 6xl:rounded-b-[7em]">
        ...
        <div className="flex items-center lg:w-full">
          <img src={logo} alt="logo" className="w-[25%] sm:w-[18%] lg:w-[10%] " />
        </div>
        ...
        >
          ...
          >
            <a href="#tentang" className="text-[#DCDCDC] duration-500 sm:duration-[0s]">
              TENTANG
            </a>
          </li>
          <li
          ...
          >
            <a href="#role" className="text-[#DCDCDC] duration-500 sm:duration-[0s]">
              ROLE
            </a>
          </li>

          <li className="text-xl sm:text-2xl lg:text-base xl:text-xl"
          onClick={props.button}
          >
            <a href="#form" className="text-white ">{props.text}</a>
          </li>
        </ul>
      </div>
    </div>
